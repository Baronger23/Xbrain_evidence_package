...
```bash
while true; do
  PGPASSWORD='Admin123!sport' psql -h sportfields-dev-postgres-truc.cb0qsaoy09dv.us-west-2.rds.amazonaws.com -U sportfields_pro -d sportfields -c 'SELECT 1;' -t >/dev/null 2>&1
